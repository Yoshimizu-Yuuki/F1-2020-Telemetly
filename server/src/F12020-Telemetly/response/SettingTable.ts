...
export function createSettingTableResponse(
  ...
  return [
    ...
    .map((el, index) => {
      return {
        ...
        onThrottle: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_onThrottle.toString(),
              10
            )
          : undefined,
        offThrottle: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_offThrottle.toString(),
              10
            )
          : undefined,
        ...
        frontSuspension: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_frontSuspension.toString(),
              10
            )
          : undefined,
        rearSuspension: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_rearSuspension.toString(),
              10
            )
          : undefined,
        frontAntiRollBar: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_frontAntiRollBar.toString(),
              10
            )
          : undefined,
        rearAntiRollBar: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_rearAntiRollBar.toString(),
              10
            )
          : undefined,
        frontSuspensionHeight: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[
                index
              ].m_frontSuspensionHeight.toString(),
              10
            )
          : undefined,
        rearSuspensionHeight: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_rearSuspensionHeight.toString(),
              10
            )
          : undefined,
        brakePressure: carSetupData
          ? parseInt(
              carSetupData.m_carSetups[index].m_brakePressure.toString(),
              10
            )
          : undefined,
        ...
        rearLeftTyrePressure: carSetupData
          ? parseFloat(
              carSetupData.m_carSetups[index].m_rearLeftTyrePressure.toString()
            )
          : undefined,
        rearRightTyrePressure: carSetupData
          ? parseFloat(
              carSetupData.m_carSetups[index].m_rearRightTyrePressure.toString()
            )
          : undefined,
    ...
    .sort(
      (
        firstEl: SettingTableResponse,
        secondEl: SettingTableResponse
      ): number => {
